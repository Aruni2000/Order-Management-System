                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <form method="get" class="d-flex" id="searchForm">
                                        ...
                                        <?php if (!empty($search)): ?>
                                            <a href="complete_order_list.php" class="btn btn-outline-secondary ms-2">
                            ...
                            <h5 class="mb-3">Manage Complete Orders</h5>
                            <?php if (!empty($search)): ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="order_table">
                                    ...
                                    <tbody>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="9" class="text-center">No complete Order found</td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
